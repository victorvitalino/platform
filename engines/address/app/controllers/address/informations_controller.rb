module Address
  class InformationsController < ApplicationController
    ...
    def blocks
      ...
      @blocks = Address::Unit.select(:block).where(city_id: params[:city_id]).distinct
    ...
    def groups
      ...
      @groups = Address::Unit.select(:group).where(city_id: params[:city_id], block: params[:block]).distinct
