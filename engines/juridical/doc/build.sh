...
rails $1 model atividade document_type:references action_type:references local_instance:references date_distribution:date deadline:date days end_date:date complemet:text user:references status:boolean monitoring_type attachment